...
for (i in 1998:2011) {
  HCRIS.alpha=read_csv(paste0("EmpiricalExercise1/data/data-out/unzip_raw/HCRIS_v1996/HospitalFY",i,"/hosp_",i,"_ALPHA.CSV"),
                       col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.numeric=read_csv(paste0("EmpiricalExercise1/data/data-out/unzip_raw/HCRIS_v1996/HospitalFY",i,"/hosp_",i,"_NMRC.CSV"),
                         col_names=c('RPT_REC_NUM','WKSHT_CD','LINE_NUM','CLMN_NUM','ITM_VAL_NUM'))
  HCRIS.report=read_csv(paste0("EmpiricalExercise1/data/data-out/unzip_raw/HCRIS_v1996/HospitalFY",i,"/hosp_",i,"_RPT.CSV"),
...
write_tsv(final.hcris.v1996,'EmpiricalExercise1/data/data-out/HCRIS_Data_v1996.txt',append=FALSE,col_names=TRUE)
