...
pacman::p_load(tidyverse, ggplot2, dplyr, lubridate, dtutils)


# Import data -------------------------------------------------------------

## create v1996 and v2010 data
source('EmpiricalExercise1/data-code/HCRIS-code-from-ian/H1_HCRISv1996.R')
source('EmpiricalExercise1/data-code/HCRIS-code-from-ian/H2_HCRISv2010.R')
...
write_tsv(final.hcris.data,'EmpiricalExercise1/data/data-out/HCRIS_Data.txt')
