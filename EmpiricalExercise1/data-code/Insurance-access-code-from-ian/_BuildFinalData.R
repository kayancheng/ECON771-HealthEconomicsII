...
source('EmpiricalExercise1/data-code/Insurance-access-code-from-ian/Medicaid.R')
source('EmpiricalExercise1/data-code/Insurance-access-code-from-ian/ACS.R')
...
write_tsv(final.data,'EmpiricalExercise1/data/data-out/acs_medicaid.txt')
