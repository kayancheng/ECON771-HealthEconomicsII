...
# Preliminaries -----------------------------------------------------------
kff.dat <- read_csv('EmpiricalExercise1/data/data-in/KFF_medicaid_expansion_2019.csv')
...
write_tsv(kff.final,'EmpiricalExercise1/data/data-out/medicaid_expansion.txt')
