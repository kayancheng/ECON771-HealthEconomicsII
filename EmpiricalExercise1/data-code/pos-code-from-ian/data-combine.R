...
# Import raw data ---------------------------------------------------------
for (y in 1984:1990) {
  pos.data <- read_csv(paste0("EmpiricalExercise1/data/data-out/unzip_raw/pos",y,".csv/pos",y,".csv"))
...
write_tsv(final.pos.data,'EmpiricalExercise1/data/data-out/pos-data-combined.txt',append=FALSE,col_names=TRUE)
