...
## 3.TWFE estimation
  ...
  # q3_result = msummary(list("Full"=TWFE_full, "2014"=TWFE_2014, "2015"=TWFE_2015, "2016"=TWFE_2016),
...
## 4.Event study
  ...
  q4_result = msummary(list("Full"=ES_full, "2014"=ES_full),
           shape=term + statistic ~ model,
           gof_map=NA,
           stars = TRUE
  )
...
## 5.SA Event study
  ...
  # q5_result = msummary(list("SA_141516"=SA_141516),
  #          shape=term + statistic ~ model,
  #          gof_map=NA,
  #          stars = TRUE
  # )
...
save.image (file = "EmpiricalExercise1/emp_ex1.RData")
